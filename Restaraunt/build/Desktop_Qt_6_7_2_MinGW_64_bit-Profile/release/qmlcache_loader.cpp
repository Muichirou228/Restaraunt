...
namespace _0x5f__CustomCalendar_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
int QT_MANGLE_NAMESPACE(qInitResources_qmake_resources)() {
    ::unitRegistry();
    Q_INIT_RESOURCE(build_Desktop_Qt_6_7_2_MinGW_64_bit_Profile_release_qmake_resources_qmlcache);
    return 1;
}
...
int QT_MANGLE_NAMESPACE(qCleanupResources_qmake_resources)() {
    Q_CLEANUP_RESOURCE(build_Desktop_Qt_6_7_2_MinGW_64_bit_Profile_release_qmake_resources_qmlcache);
    return 1;
}
int QT_MANGLE_NAMESPACE(qInitResources_qmake_qmake_immediate)() {
    ::unitRegistry();
    Q_INIT_RESOURCE(build_Desktop_Qt_6_7_2_MinGW_64_bit_Profile_release_qmake_qmake_immediate_qmlcache);
    return 1;
}
...
int QT_MANGLE_NAMESPACE(qCleanupResources_qmake_qmake_immediate)() {
    Q_CLEANUP_RESOURCE(build_Desktop_Qt_6_7_2_MinGW_64_bit_Profile_release_qmake_qmake_immediate_qmlcache);
    return 1;
}
